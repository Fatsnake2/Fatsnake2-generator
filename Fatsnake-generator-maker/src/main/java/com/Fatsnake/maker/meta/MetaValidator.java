package com.Fatsnake.maker.meta;
...
import com.Fatsnake.maker.meta.enums.ModelTypeEnum;
...
// generateType：如果文件结尾不为 Ftl，generateType 默认为 static，否则为 dynamic
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "Fatsnake");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.Fatsnake");
